...
const TEST_INPUT = ['In common usage, randomness is the apparent or actual lack of pattern or predictability in events.',
...
test('Reject bad strings', () => {
  ...
  markovChain.addString([]);
  expect(console.warn).toBeCalledWith('DO NOT ACCEPT ARRAY ANYMORE');
